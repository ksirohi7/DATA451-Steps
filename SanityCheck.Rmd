---
title: 'Sanity Check: Visualizations'
author: "Jadyn Ellis"
date: "2024-02-23"
...
# broad activity type, posture, walking/not walking
```

# Read In Data
```{r}
steps <- read.csv("merged_groundtruth_secbysec.csv")
steps$date_time <- strftime(as.POSIXct(steps$date_time), format="%Y-%m-%d %H:%M:%S")
```
...
# Get All Sanity Check Plots for Column Types
```{r}
dis <- steps %>%
